-- Host: 127.0.0.1
-- Generation Time: Aug 11, 2018 at 08:00 PM
...
--
-- Truncate table before insert `inventario`
--
...
INSERT IGNORE INTO `inventario` (`id`, `codigo`, `variacion`, `cantidad`, `precio`) VALUES
...
INSERT IGNORE INTO `productos` (`codigo`, `nombre`, `descripcion`, `disponible`) VALUES
